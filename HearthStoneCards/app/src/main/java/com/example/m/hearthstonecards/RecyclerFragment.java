...
public class RecyclerFragment extends Fragment implements ListItemClickListener {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View result=inflater.inflate(R.layout.fragment_recycler,container,false);
        RecyclerViewImageAdapter recyclerViewImageAdapter=new RecyclerViewImageAdapter(RecyclerActivity.mContext,this);
        RecyclerView recyclerView=result.findViewById(R.id.recyclerViewImage);
